...
function estimatePrepTime(ingredients, timePerIngredient) {
  if (typeof timePerIngredient === 'number') {
    return timePerIngredient * ingredients.length
  } else {
